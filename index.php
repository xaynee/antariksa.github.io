...
<body>
    ...
    <header class="hero">
        <div>
        <h1>  Happy  BirthDay  <span>Diah.R</span></h1>
        <p> Spesial Untukmu ( ＾◡＾)っ ♡</p>
        <ul>
            <li>
                <a href=""><ion-icon name="logo-facebook"></ion-icon>
                </a>
    ...
    <main>
        <section class="section_1">
            <div class="text">
                ...
                <p> Selamat ulang tahun pacarku tersayang, setelah lama menanti akhirnya website yang kubuat ini bisa
                    dijadikan online website, memang tidak spesial, namun hal ini menjadi suatu pencapaian yang mungkin
                    akan sangat berpengaruh bagi hidupku beberapa tahun kedepan. </p>
        ...
        <section class="section_2">
            <div class="text_2">
                ...
                <p> Sebelum section ini menjadi section doa, sebelumnya ingin kuisi dengan satu foto aibmu
                    ...
                    setion doa. </p>
                <p> dalam doa ini , jika aku mengetikkan kalimat doa dalam ajaran agama kita, mungkin agak 
                    sedikit magis. Jadi aku memutuskan untuk membuat doa versiku saja namun ku bingung untuk
                    memulainya, mungkin akan sedikit cringe. "Semoga apa yang kamu cita - citakan tercapai, 
                    semoga kamu tidak kesal saat membuka website ini, semoga apa yang aku ketik tidak terlihat 
                    cringe :)". hanya itu yang bisa kuketik di section doa kali ini. kamu bisa klik setiap logo 
                    diatas untuk menuju ke halaman tertentu ʕ •ᴥ•ʔ   </p>
                <div>
