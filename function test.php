...
if(isset($_POST['register'])){
    ...
    //insert to data base
    $insert = mysqli_query($connection, "INSERT INTO member (username, password) values ('$eusername','$epassword')");
...
// Login Functions
 if(isset($_POST['login'])){
    ...
    $un = mysqli_fetch_array($checkdb);
    $updatedname = $un['username'];

    if ($calculate > 0) {
    //if exist
    //username verification
    } if(password_verify($username,$updatedun)) {
                //if username correct
    ...
    //if fail 
     echo '
             <script>
                 alert("Something wrong maybe in your username or password input, please try again");
                 alert($updatedun);
    ...
    if ($calculate > 0) {
        ...
        //password verification
            ...
            echo '
            <script>
                alert("Something wrong maybe in your username or password input, please try again"); window.location.href="index.php";
            </script>
            ';
        }
    ...
    //     echo '
    //     <script>
    //         alert("Login Fail, please try again"); window.location.href="index.php";
    //     </script>
    //     ';
    // }
